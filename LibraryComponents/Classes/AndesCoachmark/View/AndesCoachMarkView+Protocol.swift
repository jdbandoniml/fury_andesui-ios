...
extension AndesCoachMarkView: CECoachMarkViewProtocol {
    ...
    func setBody(_ presenter: AndesCoachMarkBodyPresenter, removePrevious: Bool) {
        ...
        body.alpha = 0
        addSubview(body)
        body.autoPinEdge(.top, to: .bottom, of: navBar)
        body.autoPinEdge(toSuperviewEdge: .leading, withInset: 24)
        body.autoPinEdge(toSuperviewEdge: .trailing, withInset: 24)
        body.autoPinEdge(.bottom, to: .top, of: footer)
        layoutIfNeeded()
    }
